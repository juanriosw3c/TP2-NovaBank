...
function ModalNuevaInversion({ onClose }) {
  ...
  function handleConfirmar(e) {
    ...
    alert(`Inversion creada: ${tipo} por $${monto}`)
    onClose()
  }
...
function Inversiones() {
  ...
  return (
    <div className="min-h-[100dvh] w-full bg-[#070713] text-white">
          ...
          <div className="grid grid-cols-2 gap-4 lg:gap-5">
            ...
            <div className="bg-gradient-to-br from-violet-950/80 to-violet-900/20 border border-violet-500/25 rounded-2xl p-5 lg:p-6">
              ...
              <div className="flex justify-between">
                <div>
                  <p className="text-gray-500 text-xs mb-1">Rendimiento</p>
                  <p className="text-emerald-400 font-bold text-sm lg:text-base">+118% anual</p>
                </div>
                <div className="text-right">
                  <p className="text-gray-500 text-xs mb-1">Minimo</p>
                  <p className="font-bold text-sm lg:text-base">$1.000</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white/5 border border-white/8 rounded-2xl p-5 lg:p-6">
              ...
              <div className="flex justify-between">
                <div>
                  <p className="text-gray-500 text-xs mb-1">Rendimiento</p>
                  <p className="text-emerald-400 font-bold text-sm lg:text-base">+95% anual</p>
                </div>
                <div className="text-right">
                  <p className="text-gray-500 text-xs mb-1">Minimo</p>
                  <p className="font-bold text-sm lg:text-base">$5.000</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white/5 border border-white/8 rounded-2xl p-5 lg:p-6">
              ...
              <div className="flex justify-between">
                <div>
                  <p className="text-gray-500 text-xs mb-1">Cotizacion</p>
                  <p className="text-amber-400 font-bold text-sm lg:text-base">$1.247</p>
                </div>
                <div className="text-right">
                  <p className="text-gray-500 text-xs mb-1">Minimo</p>
                  <p className="font-bold text-sm lg:text-base">$10.000</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white/5 border border-white/8 rounded-2xl p-5 lg:p-6">
              ...
              <div className="flex justify-between">
                <div>
                  <p className="text-gray-500 text-xs mb-1">Variacion hoy</p>
                  <p className="text-emerald-400 font-bold text-sm lg:text-base">+2,4%</p>
                </div>
                <div className="text-right">
                  <p className="text-gray-500 text-xs mb-1">Minimo</p>
                  <p className="font-bold text-sm lg:text-base">$500</p>
                </div>
              </div>
            </div>
      ...
      {/* BOTON FOOTER FIJO - solo en mobile */}
      ...
      {/* MODAL */}
      {modalAbierto && <ModalNuevaInversion onClose={() => setModalAbierto(false)} />}
