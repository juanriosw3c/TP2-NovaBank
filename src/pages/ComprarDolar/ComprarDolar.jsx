  ...
  return (
    <div className="min-h-[100dvh] w-full bg-[#070713] text-white">
      ...
      <header className="relative flex items-center justify-between px-6 py-4 border-b border-white/8 bg-[#070713]">
        ...
        <div className="w-10 h-10 rounded-full bg-gradient-to-br from-violet-500 to-violet-700 flex items-center justify-center font-bold text-sm select-none">
          FG
        </div>
      </header>
      ...
      <div className="relative w-full max-w-4xl mx-auto px-6 sm:px-10 lg:px-12 pt-7 pb-28">
        ...
        <p className="text-gray-500 text-sm mb-7 pl-[52px]">
            ...
            return (
              ...
              >
                <div className="flex items-center justify-between mb-2.5">
                  ...
                  {activo && <div className="w-1.5 h-1.5 rounded-full bg-violet-400 flex-shrink-0" />}
                </div>
        ...
        <div className="bg-white/4 border border-white/8 rounded-2xl p-5 mb-4">
          ...
          >
            <span className="bg-violet-500/20 text-violet-300 text-xs font-bold px-3 py-[14px] border-r border-violet-500/20 whitespace-nowrap flex-shrink-0">
              ARS $
            </span>
            <input
              type="number"
          ...
          <div className="flex items-center rounded-xl border border-white/10 bg-white/5 overflow-hidden">
            <span className="bg-emerald-500/15 text-emerald-400 text-xs font-bold px-3 py-[14px] border-r border-emerald-500/20 whitespace-nowrap flex-shrink-0">
              USD $
            </span>
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-2.5 min-w-0">
                    <div className={`p-2 rounded-lg flex-shrink-0 ${activo ? "bg-violet-500/20" : "bg-white/8"}`}>
                      <Icon
                        size={15}
                  ...
                  <div
                    className={`w-4 h-4 rounded-full border flex-shrink-0 ml-2 flex items-center justify-center transition-all ${
        ...
        <div className="flex gap-3 p-4 rounded-xl bg-amber-500/8 border border-amber-500/20 mb-6">
          <AlertCircle size={15} className="text-amber-400 flex-shrink-0 mt-0.5" strokeWidth={1.75} />
